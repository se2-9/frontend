...
interface CreatePostProps {
  setPosts: React.Dispatch<React.SetStateAction<Post[]>>; // ✅ Accept `setPosts`
}

export default function CreatePost({ setPosts }: CreatePostProps) {
    ...
    onSuccess: (data) => {
      ...
      setPosts((prevPosts) => [
        ...prevPosts,
        {
          ...
          hourly_rate: data.post.hourly_rate,
          is_online: data.post.is_online,
        },
      ]);
